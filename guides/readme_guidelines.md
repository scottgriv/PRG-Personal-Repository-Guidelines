...
A `README.md` file is **always** required for all tiers of projects.
...
### Banner
A **banner** is only required for **Gold** projects.
...
### Badges
A list of **badges** are **always** required for all tiers of projects.
...
### Description
- A **description** is **always** required for all tiers of projects.
...
### Table of Contents
A **table of contents** is only required for **Gold** projects.
...
### Background
A **background** is only required for **Gold** projects but encouraged for **Silver** projects as well.
...
### Definitions
Optional section for **Gold** projects.
...
### Features
This is required for **Gold** projects and optional for **Silver** and **Bronze** projects.
...
### Getting Started
This section is **always** required for all tiers of projects.
...
- i.e.
    ...
    4. Run the application: 
        ...
        ```
### Configuration
This section is **optional** for all tiers of projects.
...
### Resources
This section is only required for **Gold** projects. It is highly recommended for **Silver** and **Bronze** projects as well.
...
### Project
This section is **optional** for all tiers of projects.
- It is strongly recommended for **Gold** projects, but optional for **Silver** and **Bronze** projects.
...
### Forking
This section is **optional** for all tiers of projects.
- Include any information on how to fork your project here.

### Found a Bug?
This section is **optional** for all tiers of projects.
- Include any information on how to report a bug for your project here.
...
### Footer
The **footer** is only required for **Gold** projects.
