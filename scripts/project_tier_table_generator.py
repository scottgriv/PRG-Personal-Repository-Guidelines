...
try:
    ...
    with open(MD_FILE_PATH, 'w') as md_file:
        ...
        md_file.write(f'\n<br><div align="center"><i><b>Built with GitHub Actions</b></i><br><a href="https://github.com/scottgriv/PRG-Personal-Repository-Guidelines" target="_blank"><img src="../assets/images/github-mark-white.png" alt="GitHub Icon" width="15" height="15"/><b><span> Check out PRG on GitHub!</span></b></a>'
